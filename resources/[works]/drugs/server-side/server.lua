...
-----------------------------------------------------------------------------------------------------------------------------------------
local itemList = {
	{ item = "lean", priceMin = 500, priceMax = 1000, randMin = 2, randMax = 5 },
	{ item = "ecstasy", priceMin = 500, priceMax = 1000, randMin = 2, randMax = 5 },
	{ item = "cocaine", priceMin = 500, priceMax = 1000, randMin = 2, randMax = 5 },
	{ item = "meth", priceMin = 500, priceMax = 1000, randMin = 2, randMax = 5 },
	{ item = "joint", priceMin = 500, priceMax = 1000, randMin = 2, randMax = 5 },
	{ item = "oxy", priceMin = 700, priceMax = 1000, randMin = 1, randMax = 3 },
	{ item = "heroine", priceMin = 1000, priceMax = 2000, randMin = 1, randMax = 1 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- CHECKAMOUNT
-----------------------------------------------------------------------------------------------------------------------------------------
